...
main = do
  ...
  putStrLn $ "Func. 2: entrada: 2 4; resultado: " ++ show (mdc 2 4)
  putStrLn $ "Func. 3: entrada: 1234; resultado: " ++ show (somaDigs 1234)
  -- q4. Escreva uma função que devolva a soma de todos os números menores que 10000 que sejam múltiplos de 3 ou 5.
  putStrLn $ "Func. 4: entrada: 10000; resultado: " ++ show (sum ([n | n <- [1 .. 9999], n `mod` 3 == 0 || n `mod` 5 == 0]))
  putStrLn $ "Func. 5: entrada: [1,2,3,4,5]; resultado: " ++ show (diferenca [1, 2, 3, 4, 5])
  putStrLn $ "Func. 6: entrada: 30; resultado: " ++ show (euler 30)
  putStrLn $ "Func. 7: entrada: 15; resultado: " ++ show (reverse (lucas 15))
  putStrLn $ "Func. 8: entrada: [1,2,3]; resultado: " ++ show (aoContrario [1, 2, 3])
  putStrLn $ "Func. 9: entrada: 8 8; resultado: " ++ show (somaRecursiva 8 8)
  putStrLn $ "Func. 10: entrada: [1, 2, 3, 4, 5, 6, 7, 10, 20, 15]; resultado: " ++ show (comprimento [1, 2, 3, 4, 5, 6, 7, 10, 20, 15])
